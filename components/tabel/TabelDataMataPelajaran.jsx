...
const TabelDataMataPelajaran = ({ filteredData }) => {
              ...
              filteredData.map((item, index) => (
                ...
                >
                  ...
                  <TableCell className="py-2.5 flex gap-2">
                    <Link href={`/master/mapel/edit?id=${item.id}`}>
                      <Button
                        variant="default"
                        size="sm"
      ...
      {openDelete !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-background p-6 rounded-lg shadow-lg flex flex-col items-center gap-4">
            <h3 className="font-bold text-lg">Hapus Mata Pelajaran Ini?</h3>
...
export default TabelDataMataPelajaran;
